# -*- coding: utf-8 -*-
"""Employee Rentation Prediction

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1b8Cfpcm2w4tlvVrU0B2Eq2_ZZpLhRDrH
...
# Store results
results = {}
models = {"Logistic Regression": log_reg, "Random Forest": rf, "KNN": knn}
...
* Three models were selected for this task: Logistic Regression, Random Forest, and K-Nearest Neighbors (KNN).
...
* Three classification models (Logistic Regression, Random Forest, and KNN) were chosen for this task.
